...
export class Migration1660400534403 implements MigrationInterface {
    name = 'Migration1660400534403'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `channels_tags` (`id` int NOT NULL AUTO_INCREMENT, `tag_id` int NOT NULL, `tag_name` varchar(255) NOT NULL, `channel_id` int NOT NULL, `genre_id` int NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `sub_comments` (`id` int NOT NULL AUTO_INCREMENT, `comment` text NOT NULL, `time` varchar(255) NOT NULL, `user_id` int NOT NULL, `master_comment_id` tinyint NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `channel_id` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `master_comments` (`id` int NOT NULL AUTO_INCREMENT, `comment` text NOT NULL, `picture` varchar(255) NULL, `key` varchar(255) NULL, `time` varchar(255) NOT NULL, `user_id` int NOT NULL, `channel_id` int NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
